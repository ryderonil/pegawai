...
?> </h2>
	<?php echo form_open('bpw/save_jamaah'); ?>
    ...
    <tr>
    <td width=2%></td>
    <td width=17%>Melalui KL / KA </td>
    <td width=2%>:</td>
    <td>
    <select name="kl">
	<?php foreach ($klnya->result() as $item):?>
	 <option value="<?php echo $item->id_kl;
	 ?>"><?php echo $item->nama_kl;?></option>
	<?php endforeach; ?>
    ...
    <td width=2%>:</td>
    <td><input type=text required="required" name='nama_lengkap' size=77></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Bin / Binti </td>
  ...
  <tr>
    ...
    <select required="required" name='bln'>
				  ...
				  Tahun <input type=text maxlength="4" name='thn' size=5> </td>
  </tr>
  <tr>
    <td>3.</td>
    <td>Nomor KTP </td>
  ...
  <tr>
    ...
    <td>Telepon</td>
    <td>:</td>
    <td><input type=text name='t1' maxlength="4" size=5> <input type=text name='t2' size=10> Hp. <input type=text name='hp' maxlength="14" size=20></td>
  </tr>
  <tr>
    <td>9.</td>
