...
<h2>Tambah paket</h2>
          <?php echo form_open('admin/save_paket'); ?>
          <table>
		  ...
		  <tr><td width=70>Harga (QRD)</td>     <td> : <input type=text onkeypress="return angka(event)" required="required" name='harga_qrd' size=25></td></tr>
          ...
          <textarea name="ket" style="width: 600px; height: 200px; resize:none;"></textarea>
