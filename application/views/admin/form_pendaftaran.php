...
?> </h2>
	<?php echo form_open('admin/save_jamaah'); ?>
  ...
  <tr>
    ...
    <td>:</td> 
    <td><input required="required" type=text name='tempat' size=20>    Tgl <input required="required" type=text maxlength="2" name='tgl' size=2>  Bln <select  required="required" name='bln'>
  ...
  <tr>
   ...
   melalui : <select name='keterangan'>
