...
<div id="header">
	<div id="menu">
      <ul>
        ...
        <li><a href="<?php echo base_url(); ?>admin/list_user">&#187; Manajemen User</a></li>
    <!--     <li><a href="<?php echo base_url(); ?>admin/modul">&#187; Manajemen Modul</a></li>  -->
        <li><a href="<?php echo base_url(); ?>admin/pendaftaran">&#187; Pendaftaran</a></li>
        <li><a href="<?php echo base_url(); ?>umum/data_jamaah">&#187; Data Jamaah</a></li>
        <li><a href="<?php echo base_url(); ?>admin/list_paket">&#187; Paket</a></li>
     <!-- <li><a href="<?php echo base_url(); ?>admin">&#187; Kelengkapan</a></li> -->
        <li><a href="<?php echo base_url(); ?>admin/penjualan">&#187; Penjualan</a></li>
        <li><a href="<?php echo base_url(); ?>admin/penjualan_user">&#187; Penjualan Setiap User</a></li>
