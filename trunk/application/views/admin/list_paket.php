<h2>Paket</h2>
          <input type=button value='Tambah Paket' onclick="window.location.href='<?php echo base_url(); ?>admin/add_paket';">
           <input type=button value='excel' onclick="window.location.href='<?php echo base_url(); ?>admin/download';">
