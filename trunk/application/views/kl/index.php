...
<div id="header">
	<div id="menu">
      <ul>
        ...
        <li><a href="<?php echo base_url(); ?>kl">&#187; Home</a></li>
        <li><a href="<?php echo base_url(); ?>umum/editprofil">&#187; Manajemen User</a></li>
        <li><a href="<?php echo base_url(); ?>kl/pendaftaran">&#187; Pendaftaran</a></li>
        <li><a href="<?php echo base_url(); ?>umum/list_jamaah">&#187; Data Jamaah Tiap KL</a></li>
