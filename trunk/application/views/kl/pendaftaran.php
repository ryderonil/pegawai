<h2>Pendaftaran</h2>
	...
	<tr align="left">
		...
		<td align=center><?php echo anchor('kl/isi_pendaftaran/'.$row['id_paket'].'/'.'qrd', $row['harga_qrd']);?></td>
		<td align=center><?php echo anchor('kl/isi_pendaftaran/'.$row['id_paket'].'/'.'tpl', $row['harga_tpl']);?></td>
		<td align=center><?php echo anchor('kl/isi_pendaftaran/'.$row['id_paket'].'/'.'dbl', $row['harga_dbl']);?></td>
