 ...
 $user = $row['id_kl'];
		$u=$this->db->query("SELECT * FROM kl WHERE `id_kl`='$user'");
		$nama_kl=$u->row()->nama_kl;
  endforeach;
...
?>
 ...
 <table width=650 border="0">
  ...
  <tr>
   <td><input type=button value='excel' onclick="window.location.href='<?php echo base_url(); ?>umum/ex_perpaket_user/<?php echo $xx; ?>';"></td>
    <td align="right"><form method="post" action="<?php 
    
    echo base_url();?>umum/jumlah_jamaah_paket_user/<?php echo $xx; ?>">
