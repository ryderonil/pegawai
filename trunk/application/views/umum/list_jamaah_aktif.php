 ...
 <table width=650>
  <tr>
   ...
   <td><input type=button value='excel' onclick="window.location.href='<?php echo base_url(); ?>umum/ex_semua_jamaah_aktif';"> </td>
    <td align="right"><form method="post" action="<?php echo base_url();?>umum/list_penjualan">
